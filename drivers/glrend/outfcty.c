 ...
 */
static br_error BR_CMETHOD_DECL(br_output_facility_gl, pixelmapNew)(br_output_facility* self,
 ...
 */
static br_error BR_CMETHOD_DECL(br_output_facility_gl, clutNew)(br_output_facility* self, br_device_clut** pclut,
    br_token_value* tv) {
    (void)self;
    (void)pclut;
    (void)tv;
...
static br_error BR_CMETHOD_DECL(br_output_facility_gl, queryCapability)(br_output_facility* self, br_token_value* buffer_in,
...
static void* BR_CMETHOD_DECL(br_output_facility_gl, listQuery)(struct br_object_container* self) {
...
static const struct br_output_facility_dispatch outputFacilityDispatch = {
    ...
    .__reserved2 = NULL,
    .__reserved3 = NULL,
    ._free = BR_CMETHOD_REF(br_output_facility_gl, free),
    ._identifier = BR_CMETHOD_REF(br_output_facility_gl, identifier),
    ._type = BR_CMETHOD_REF(br_output_facility_gl, type),
    ._isType = BR_CMETHOD_REF(br_output_facility_gl, isType),
    ._device = BR_CMETHOD_REF(br_output_facility_gl, device),
    ._space = BR_CMETHOD_REF(br_output_facility_gl, space),

    ._templateQuery = BR_CMETHOD_REF(br_output_facility_gl, queryTemplate),
    ...
    ._listQuery = BR_CMETHOD_REF(br_output_facility_gl, listQuery),
    ...
    ._validSource = BR_CMETHOD_REF(br_output_facility_gl, validSource),
    ._pixelmapNew = BR_CMETHOD_REF(br_output_facility_gl, pixelmapNew),
    ._clutNew = BR_CMETHOD_REF(br_output_facility_gl, clutNew),
    ._queryCapability = BR_CMETHOD_REF(br_output_facility_gl, queryCapability),
};
